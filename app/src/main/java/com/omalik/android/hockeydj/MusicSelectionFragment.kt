...
import com.omalik.android.hockeydj.databinding.FragmentMusicSelectionListBinding


class MusicSelectionFragment : Fragment(),
    SpotifyTrackInterface,
    MusicSelectionAdapter.OnNoteCheckboxListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = DataBindingUtil.inflate(inflater,
            R.layout.fragment_music_selection_list, container, false)
        ...
        SpotifyService.trackInterface = this
        when (mode) {
            "playlist" -> SpotifyService.getTracksFromPlaylist(
                tracksUrl
            )
            "album" -> SpotifyService.getTracksFromAlbum(
                tracksUrl
            )
        }
    ...
    override fun tracksHandler(tracks: List<Track>) {
        ...
        songList.adapter = MusicSelectionAdapter(
            this.context!!,
            tracks,
            activeHoekyPlaylist,
            albumArtwork,
