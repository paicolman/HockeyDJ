...
object SpotifyService {
    ...
    fun authenticate() {
        ...
        val CLIENT_ID = "b32845f658dd4555b235e346f7eeaa34" //Hockey DJ in Spotify dashboard
        //val CLIENT_ID = "d90d06bbaeb446e1a1458607d6662861"   //Hockey DJ DEBUG in Spotify dashboard
    ...
    private fun connect() {
        ...
        SpotifyAppRemote.connect(context,connectionParams, object : Connector.ConnectionListener {
                ...
                override fun onFailure(throwable: Throwable) {
                    Log.e(TAG, "Connection failure: ${throwable.message}")
        ...
        if (requestCode == REQUEST_CODE) {
            ...
            when (response.type) {
                ...
                AuthenticationResponse.Type.CODE -> {
                    ...
                    Log.e(TAG, "ActivityRresult returns: AuthenticationResponse.Type.CODE - what to do?")
                }
                AuthenticationResponse.Type.EMPTY -> {
                    //TODO: What to do here?
                    Log.e(TAG, "ActivityRresult returns: AuthenticationResponse.Type.EMPTY - what to do?")
                }
                AuthenticationResponse.Type.UNKNOWN -> {
                    //TODO: What to do here?
                    Log.e(TAG, "ActivityRresult returns: AuthenticationResponse.Type.UNKNOWN - what to do?")
                }
                else -> {
                    //TODO: What to do here?
                    Log.e(TAG, "ActivityRresult returns: <something else> - what to do?")
                }
            }
                ...
                SpotifyRequest(
                    Request.Method.GET, url, null, Response.Listener { response ->
                        ...
                        for (i in 0 until playlistArray.length()) {
                            ...
                            if (images.length() > 0) {
                                val imageData =
                                    images[0] as JSONObject //Get just the first one you find...
                        ...
                        dataInterface?.mediaCollectionHandler(
                            playlistData
                        )
                    },
                    Response.ErrorListener {
                        Log.e(
                            TAG,
                            "We had problems getting playlists"
                        )
                        Log.e(
                            TAG,
                            it.toString()
                        )
                        dataInterface?.dataRequestError(
                            it
                        )
                    }, TOKEN
                )
            ...
            val jsonRequest =
                SpotifyRequest(
                    ...
                    Response.ErrorListener {
                        Log.e(
                            TAG,
                            "We had problems getting albums"
                        )
                        Log.e(
                            TAG,
                            it.toString()
                ...
                SpotifyRequest(
                    Request.Method.GET, tracksUrl, null, Response.Listener { response ->
                        ...
                        for (i in 0 until tracksArray.length()) {
                            ...
                            tracks.add(
                                Track(
                                    name, trackUri, artistName, imageUrl,
                                    false, false, false, false, false, false, false
                                )
                            )
                        }
                        trackInterface?.tracksHandler(
                            tracks
                        )
                    },
                    Response.ErrorListener {
                        Log.e(
                            TAG,
                            "We had problems getting tracks!"
                        )
                        Log.e(
                            TAG,
                            it.toString()
                        )
                        trackInterface?.trackRequestError(
                            it
                        )
                    }, TOKEN
                )
            ...
            val jsonRequest =
                SpotifyRequest(
                    ...
                    Response.ErrorListener {
                        Log.e(
                            TAG,
                            "We had problems getting album tracks!"
                        )
                        Log.e(
                            TAG,
                            it.toString()
